...
<body>
    <?php
        ...
        echo "<a href='../view/vista-blanca.php' class='btn btn-dark' style='padding-left: 60px; padding-right: 60px; border-color: white''>Back</a>";
        echo "</div>";
        ...
        if(!isset($_POST['enviar'])){
            ...
            foreach($sentencia as $row){
                echo "<tr class='tbl_eventos'>";
                    ...
                    echo "<td><a class='btn btn-warning' href='../process/modificarform-blanca.php?id={$row['id_reserva']}'>Modificar</a></td>";
                    echo "<td><a class='btn btn-danger' href='../process/liberar-blanca.php?id={$row['id_reserva']}'>Eliminar</a></td>";
                echo "</tr>";
            }
        }else{
            $table = $_POST['id_mesa'];
