...
<body>
    ...
    <?php
        ...
        echo "<a href='../view/vista-azul.php' class='btn btn-dark' style='padding-left: 60px; padding-right: 60px; background-color: #1c497a;'>Back</a>";
        echo "</div>";
        echo "<h1>Reservas de la Sala Azul</h1>";

        $stmt = $pdo->prepare("SELECT * FROM tbl_reserva where id_mesa >= 17 and id_mesa <= 24 ORDER BY fecha_inicio ASC");
            $stmt->execute();
