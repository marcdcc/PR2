...
echo "</div>";
echo "<br><br>";
echo "<h1>Mesas y reservas de la Sala Azul</h1>";
...
<div class="btn_reservas">
    <a href="../view/reservas-azul.php" type="button" class='btn btn-primary' style='padding-left: 100px;padding-right: 100px; border-color: white; background-color: #1c497a; font-size: 20px;'>Ver Reservas</a>
</div>
</body>
</html>