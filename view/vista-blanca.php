...
foreach ($listaMesas as $mesa) {    
    ...
    echo "<tr>";
    echo "<td><a type='button' class='btn btn-outline-dark' href='../process/generarform-blanca.php?id={$mesa['id_mesa']}&nsillas={$mesa['num_silla_dispo']}'>Generar reserva</a></td>";
    echo "</tr>";
...
<div class="btn_reservas">
    <a href="../view/reservas-blanca.php" type="button" class='btn btn-dark' style='padding-left: 100px;padding-right: 100px; border-color: white; font-size: 20px;'>Ver Reservas</a>
</div>
</body>
</html>