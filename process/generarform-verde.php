...
<div class='inicio'>
<a href='../view/vista-verde.php' class='btn btn-success' style='padding-left: 60px; padding-right: 60px; background-color: #146025;'>Back</a>
</div>

<form action="generarpdo-verde.php" method="post" class="caja" onsubmit="return validar()">
        ...
        <br>
        <input type="submit" value="Reservar" class="btn btn-dark" style='padding-left: 30px; padding-right: 30px; background-color: #146025;'>
</form>
</body>
</html>