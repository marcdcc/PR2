...
try {
    ...
    if($comprobar_reserva > 0){
        echo "<script>alert('Ya hay una reserva para este dia y esta hora'); window.location.href='../view/vista-verde.php';</script>";
    }else{
        ...
        header('Location: ../view/reservas-verde.php');
        ob_end_flush();
    }
}
