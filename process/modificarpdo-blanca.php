...
try {
    ...
    if($comprobar_reserva > 0){
        echo "<script>alert('Ya hay una reserva para este dia y esta hora'); window.location.href='../view/vista-blanca.php';</script>";
    }else{
        ...
        header('Location: ../view/reservas-blanca.php');
        ob_end_flush();
    }
}
