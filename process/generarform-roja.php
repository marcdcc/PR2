...
<div class='inicio'>
<a href='../view/vista-roja.php' class='btn btn-danger' style='padding-left: 60px;padding-right: 60px; background-color: #7e2029;'>Back</a>
</div>

<form action="generarpdo-roja.php" method="post" class="caja" onsubmit="return validar()">
        ...
        <br>
        <input type="submit" value="Reservar" class="btn btn-dark" style='padding-left: 30px; padding-right: 30px; background-color: #7e2029;'>
</form>
</body>
</html>